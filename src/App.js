...
import {default as Wallet_zh} from './Wallet_zh/wallet';
import {default as Wallet_en} from './Wallet_en/wallet';
    ...
    return (
      <LocalizeProvider>
        <HashRouter>
          <ScrollToTop>
            <Switch>
              <Route path="/" exact component={isChinese ? Wallet_zh : Wallet_en} />
